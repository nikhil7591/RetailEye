  ...
  return (
    <Card className="h-full border-[#E2E8F0]">
      <CardHeader className="py-5 border-b border-[#E2E8F0] flex flex-row items-center justify-between">
        ...
        <Button variant="outline" size="sm" className="h-[34px] px-4 text-xs font-semibold text-[#4F46E5] border-[#E0E7FF] bg-[#FFFFFF] hover:bg-[#EEF2FF] shadow-sm rounded-lg">
          <Download className="mr-2 h-3.5 w-3.5" />
          Export Report
        </Button>
      </CardHeader>
      <CardContent className="p-0 overflow-auto h-[calc(100%-61px)]">
        <Table>
          <TableHeader>
            <TableRow className="bg-[#FFFFFF] hover:bg-[#FFFFFF] border-b border-[#E2E8F0]">
              <TableHead className="w-12 h-10 text-[11px] font-bold text-[#64748B]">#</TableHead>
              <TableHead className="h-10 text-[11px] font-bold text-[#64748B]">File Name</TableHead>
              <TableHead className="h-10 text-[11px] font-bold text-[#64748B]">Date & Time</TableHead>
          ...
          <TableBody>
            {data.map((analysis) => (
              <TableRow key={analysis.id} className="border-b border-[#F1F5F9] hover:bg-[#F8FAFC]">
                ...
                <TableCell className="font-semibold text-[#334155] text-xs h-12">{analysis.file}</TableCell>
                <TableCell className="text-[#64748B] font-medium text-xs h-12">{analysis.time}</TableCell>
                <TableCell className="text-center font-semibold text-[#334155] text-xs h-12">{analysis.score}/100</TableCell>
